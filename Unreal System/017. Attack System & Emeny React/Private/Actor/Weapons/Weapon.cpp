...
void AWeapon::OnBoxOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	UKismetSystemLibrary::BoxTraceSingle(
		...
		FVector(5.0f, 5.0f, 5.0f),	// FVector halfSize : 중심점으로 부터 박스 크기
		BoxTraceStart->GetComponentRotation(),	// Box Trace의 방향 = Start의 Rotation
		ETraceTypeQuery::TraceTypeQuery1,	// ETraceTypeQuery : Box Trace는 기본적으로 Visibility
		false,	// bool bTraceComplex
		ActorsToIgnore, // const TArray<AActor*> ActorToIgnore
		EDrawDebugTrace::ForDuration,	//EDrawDebugTrace::Type DrawDebugType
