...
private:
	...
	*/
	...
	// 무기 교체주이면 true
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Combat | Equipping", meta = (AllowPrivateAccess = "true"))
	...
	// FABRIK이 적용되도 되는지 (재장전, 무기 장착 모션중이면 false)
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Combat | Weapon", meta = (AllowPrivateAccess = "true"))
