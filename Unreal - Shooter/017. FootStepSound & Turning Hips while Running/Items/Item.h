...
struct FItemRarityTable : public FTableRowBase
{
	...
	// Weapon Widget에서 밝은 부분
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	FLinearColor LightColor;

	// Weapon Widget에서 어두운 부분
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
...
public:
	...
	*/
	...
	// Inventory에서 사용하는 Icon
	FORCEINLINE void SetIconItem(UTexture2D* Icon) { IconItem = Icon; }
	// Weapon Widget에서 사용하는 Icon
	FORCEINLINE void SetAmmoIcon(UTexture2D* Icon) { IconAmmo = Icon; }
	FORCEINLINE void SetMaterialIndex(int32 Index) { MaterialIndex = Index; }
	FORCEINLINE int32 GetMaterialIndex() const { return MaterialIndex; }
	FORCEINLINE void SetMaterialInstacne(UMaterialInstance* Material) { MaterialInstance = Material; }
	FORCEINLINE UMaterialInstance* GetMaterialInstacne() const { return MaterialInstance; }
...
private:
	...
	*/
	...
	// 총알 갯수, 등 아이템 갯수 정보 (탄창에 장전되지 않은 여분 총알)
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Item Properties", meta = (AllowPrivateAccess = "true"))
	int32 AmmoCount{ 0 };

	// Item의 희귀도 표시(Widget에서 별 갯수)
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Item Properties | Rarity", meta = (AllowPrivateAccess = "true"))
	...
	*/
	...
	// glow material에 사용할 색
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Item Properties | Rarity", meta = (AllowPrivateAccess = "true"))
	FLinearColor GlowColor;

	// Weapon Widget에서 밝은 부분 색상
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Item Properties | Rarity", meta = (AllowPrivateAccess = "true"))
	FLinearColor LightColor;

	// Weapon Widget에서 어두운 부분 색상
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Item Properties | Rarity", meta = (AllowPrivateAccess = "true"))
	FLinearColor DarkColor;

	// Weapon Widget에서 표시될 별의 갯수
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Item Properties | Rarity", meta = (AllowPrivateAccess = "true"))
	int32 NumberOfStars;

	// Inventory Slot에서 사용될 뒷배경
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Item Properties | Rarity", meta = (AllowPrivateAccess = "true"))
